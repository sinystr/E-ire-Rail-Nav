...
@objc class AddRouteViewController: UIViewController, AddRouteViewProtocol, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @objc public var presenter: AddRoutePresenterProtocol?
    ...
    func setupView(withStations stations: [StationModel]) {
    ...
    @IBAction func addRouteButtonPressed(_ sender: Any) {
        ...
        presenter?.addRoute(with: fromStation, toStation: toStation, bidirectional: bidirectionalSwitch.isOn)
    }
}
